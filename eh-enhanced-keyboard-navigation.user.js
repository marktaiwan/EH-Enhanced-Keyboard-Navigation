...
function getPageType() {
  ...
  const indexReg = new RegExp('^https?://(exhentai|e-hentai)\\.org(/((doujinshi|manga|artistcg|gamecg|western|non-h|imageset|cosplay|asianporn|misc|tag/[\\w\\+:-]+)(/\\d+)?/?|(popular|watched|favorites\\.php)?(\\?.*)?))?$');
